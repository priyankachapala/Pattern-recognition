...
accuracy_pca_2d_1d = (correct1+correct2)/(length(Test1)+length(Test2));

acc = ['Accuracy using PCA 2D to 1D and threshold as middle point is:',num2str(accuracy_pca_2d_1d)];
disp(acc);